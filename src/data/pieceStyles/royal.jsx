...
// Inspired by luxury porcelain chess sets. Thin strokes, decorative details.
  ...
  wK: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g style={{ fill: 'none', fillRule: 'evenodd', stroke: '#000000', strokeWidth: '1.5', strokeLinecap: 'round', strokeLinejoin: 'round' }}>
        {/* Ornate cross */}
        <path d="M 22.5,11.63 L 22.5,6" style={{ fill: 'none', stroke: '#000000' }} />
        <path d="M 20,8 L 25,8" style={{ fill: 'none', stroke: '#000000' }} />
        {/* Crown flame shape */}
        <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" style={{ fill: props?.fill ?? '#ffffff', stroke: '#000000', strokeLinecap: 'butt' }} />
  ...
  bK: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g style={{ fill: 'none', fillRule: 'evenodd', stroke: '#000000', strokeWidth: '1.5', strokeLinecap: 'round', strokeLinejoin: 'round' }}>
        <path d="M 22.5,11.63 L 22.5,6" style={{ fill: 'none', stroke: '#000000' }} />
        <path d="M 20,8 L 25,8" style={{ fill: 'none', stroke: '#000000' }} />
        <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" style={{ fill: props?.fill ?? '#000000', fillOpacity: 1, stroke: '#000000', strokeLinecap: 'butt' }} />
  ...
  wQ: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g style={{ fill: props?.fill ?? '#ffffff', stroke: '#000000', strokeWidth: '1.5', strokeLinejoin: 'round' }}>
        {/* Crown with elegant points */}
        <path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z" />
        {/* Body — elegant flowing curves */}
  ...
  wR: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g style={{ fill: props?.fill ?? '#ffffff', stroke: '#000000', strokeWidth: '1.5', strokeLinecap: 'round', strokeLinejoin: 'round' }}>
        ...
        <path d="M 31,17 L 31,29.5 L 14,29.5 L 14,17" style={{ strokeLinecap: 'butt' }} />
        <path d="M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5" />
        <path d="M 11,14 L 34,14" style={{ fill: 'none', stroke: '#000000' }} />
      </g>
    </svg>
  ),
  bR: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <g style={{ fill: props?.fill ?? '#000000', stroke: '#000000', strokeWidth: '1.5', strokeLinecap: 'round', strokeLinejoin: 'round' }}>
        <path d="M 9,39 L 36,39 L 36,36 L 9,36 z" style={{ strokeLinecap: 'butt' }} />
        <path d="M 12.5,32 L 14,29.5 L 31,29.5 L 32.5,32 z" style={{ strokeLinecap: 'butt' }} />
        <path d="M 12,36 L 12,32 L 33,32 L 33,36 z" style={{ strokeLinecap: 'butt' }} />
